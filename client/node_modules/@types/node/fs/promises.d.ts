...
import {
    BaseEncodingOptions, BigIntStats, BufferEncodingOption, Dir, Dirent, MakeDirectoryOptions, Mode,
    OpenDirOptions, OpenMode, PathLike, ReadVResult, RmDirOptions, RmOptions, StatOptions, Stats,
    WriteVResult
} from 'node:fs';
